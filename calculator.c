...
void linspace(double *x, double a, double b, int c);
void saveArray(double *x, char *str);
...
linspace(k,-12.0,15.0,len);
saveArray(k,"k.dat");
int w = sizeof(k)/sizeof(double);
printf("\n%d\n",w);
